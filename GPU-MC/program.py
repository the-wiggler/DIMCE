...
integral_calc = IntegralMC(
    batches=15000,  # Number of times that sets of integral should be estimated ( y in calc_int array )
    int_per_batch=6,  # How many estimates of integral should be output per batch ( x in calc_int array )
