...
integral_calc = IntegralMC(
    batches=4000,  # Number of times that sets of integral should be estimated ( y in calc_int array )
    ...
    hist_factor=1000,  # factor in which histories are multiplied in order to create a gradient for data analysis,
    repetition_factor=2,
